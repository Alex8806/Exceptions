...
бросить исключение, соответствующее типу проблемы. Можно использовать встроенные типы java и создать свои. Исключение должно быть корректно обработано,
...
public class Main {
    public static void main(String[] args) {
        ...
        Entry entry = null;
        DataSaverToTXT ds = new DataSaverToTXT();
        try{
            entry = di.Input();
            ds.save(entry);
        }
